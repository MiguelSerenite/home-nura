/**
 * Phase BB — /entretien-maison silo hub (noindexed until depth gate).
...
const SILO_SLUG = 'entretien-maison' as const
...
export default async function EntretienMaisonPage({
  params,
}: {
  params: Promise<{ lang: string }>
}) {
