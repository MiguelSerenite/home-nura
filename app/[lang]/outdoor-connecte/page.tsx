/**
 * Phase BB — /outdoor-connecte silo hub (noindexed until depth gate).
...
const SILO_SLUG = 'outdoor-connecte' as const
...
export default async function OutdoorConnectePage({
  params,
}: {
  params: Promise<{ lang: string }>
}) {
